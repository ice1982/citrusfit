...
class GalleryAlbum extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, created_user, created_username, modified_user, modified_username', 'required'),
			array('created_user, modified_user, active', 'numerical', 'integerOnly'=>true),
			array('title, description, created_ip, modified_ip, modified_username', 'length', 'max'=>300),
			array('created_username', 'length', 'max'=>200),
			array('created_date, modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, description, created_ip, created_date, created_user, created_username, modified_ip, modified_date, modified_user, modified_username, active', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
            'galleryItems' => array(self::HAS_MANY, 'GalleryItem', 'album_id'),
