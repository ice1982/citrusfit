    ...
    <td>
        <div class="image">
            <?php if (!empty($catalog_group->image)) : ?>
                <a href="<?=Yii::app()->createUrl('catalog/index', array('group' => $catalog_group->id))?>" title="<?=$catalog_group->title?>">
                    <img src="/uploads/catalog/<?=$catalog_group->image?>" alt="<?=$catalog_group->title?>">
                </a>
            <?php endif; ?>
        </div>
        <div class="title">
            <?=CHtml::link(CHtml::encode($catalog_group->title), Yii::app()->createUrl('catalog/index', array('group' => $catalog_group->id)))?>
        </div>
    </td>
