...
class Banner extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('title, image, created_username, modified_username', 'required'),
			array('club_id, nn, created_user, modified_user, active', 'numerical', 'integerOnly'=>true),
			...
			array('id, club_id, title, link, image, image_attr_title, image_attr_alt, nn, created_ip, created_date, created_user, created_username, modified_ip, modified_date, modified_user, modified_username, active', 'safe', 'on'=>'search'),
		);
	}
