<div style="display:none">
    <div id="modalGroupRequest" class="modal-window">
        <h4><?=$caption?></h4>
        <?php $form = $this->beginWidget('CActiveForm', array(
            'id' => 'modalGroupRequestForm',
            'action' => Yii::app()->createUrl('ajax/sendFromModalGroupRequestForm'),
            'enableAjaxValidation' => true,
            'enableClientValidation' => true,
            'clientOptions' => array(
                'validationUrl' => Yii::app()->createUrl("ajax/sendFromModalGroupRequestValidation" ),
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <?=CHtml::submitButton(
                        $button,
                        array(
                            'id' => 'modalGroupRequestFormSubmit',
